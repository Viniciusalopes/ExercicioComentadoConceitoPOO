...
public class Conceito { 
    ...
    private float raio = 0 ;      // VISIBILIDADE ===> São distribuídas em três tipos, 
                                  ...
                                  // ÒBJETO ===> são características definidas pelas classes. 
     ...
     * @return the raio
     */
    public float getRaio() {               // ENCAPSULAMENTO ===> Restringir o acesso do comportameto interno de um Objeto.
        return raio;                       // Sempre com os métodos privados ligadas a métodos especiais chamados getters e setters,
    ...
    public void setRaio(float raio) throws Exception{  //Todo throw esta ligado ao objeto Exception
       ...
       //parametro raio 
        this.raio = raio; // this só pode colocar ao lado de atributo (Escopo maior da classe) ou seja, enxerga outro escopo.
